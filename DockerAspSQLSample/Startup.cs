...
namespace DockerAspSQLSample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var database = Configuration["Database"] ?? "AppDbContext";
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DockerAspSQLSample", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "DockerAspSQLSample v1"));
            }
